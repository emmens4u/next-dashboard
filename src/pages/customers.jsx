                             ...
                             sm:grid-cols-3 grid-cols-2 items-center justify-between cursor-pointer'>
                                <div className='flex items-center'>
                                    <div className='bg-sky-100 p-3 rounded-lg'>
                                        <BsPersonFill className='text-sky-800'/>
                                    </div>
                                    <p className='pl-4'>{order.name.first + " " + order.name.last}</p>
                                </div>
                                <p className='text-gray-600 sm:text-left text-right sm:text-base text-sm'>{order.name.first}@gmail.com</p>
